...
if store.lower() == 'bath and body works':
    ...
    # choice: candles
        ...
        print('Candles are a great gift for your friends and family, especially for this cold winter season! And you')
...
# choice: pacsun
    ...
    # choice: jeans
        ...
        print('A good pair of jeans is essential for the winter! There are so many different styles and colors.')
